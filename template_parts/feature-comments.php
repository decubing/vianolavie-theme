...
<div class="feature-comments">
  ...
  $comment_settings = array(
    'logged_in_as' => '',
     'must_log_in' => '<div class="comments-notice">' . sprintf( __( 'You must be <a href="%s">login</a> to post a comment.' ),wp_login_url( apply_filters( 'the_permalink', get_permalink( $post_id ) ) )) . ' Need a ViaNolaVie user? <a href="'.get_permalink( get_page_by_path( 'register') ).'">Click here</a> to signup.</div>',
